...
export class ProductComponent implements OnInit {
  products: Product[] = [];
  newProduct: Product = { product_name: '', product_price: 0, stock_quantity:0,product_category:'',product_description:''};
  ...
  addProduct() {
    this.productService.addProduct(this.newProduct).subscribe((response:any) => {
      ...
      this.loadProducts();
      this.newProduct = { product_name: '', product_price:0, stock_quantity:0,product_category:'',product_description:''};
    });
  }
